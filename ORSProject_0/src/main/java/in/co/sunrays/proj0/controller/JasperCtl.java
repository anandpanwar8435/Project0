...
public class JasperCtl {
	...
	public void display(HttpServletRequest request, HttpServletResponse response) throws JRException, SQLException, IOException {
		...
		String path = context.getRealPath("E:\\ORSProj0\\ORSProject_0\\src\\main\\webapp\\WEB-INF\\Cherry_Landscape2.jrxml");
		System.out.println("in jasper");
		Connection con = null;
		JasperReport jasperReport = JasperCompileManager.compileReport("E:\\ORSProj0\\ORSProject_0\\src\\main\\webapp\\WEB-INF\\Cherry_Landscape2.jrxml");
