...
<div class="logo">
 <img src="<c:url value="/resources/img/icon.jpg"></c:url>"  width="70px" height="35px" alt="okgoogle">

   <a id="ab" href="javascript:void(0)" style="padding: 0% 0% 5% 0%;color: orange;"  class="closebtn " onclick="closeNav()">&times;</a>
